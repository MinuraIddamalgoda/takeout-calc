...
SECRET_KEY = "django-insecure-*l=8f%9s(0ckg+7@2zl^^d=26+_1=3hu-267h$wo)2+lu_b%ik"
...
TEMPLATES = [
    {
        ...
        "DIRS": [("%s/templates" % app_name)],  # <-- Relative to repo root
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
STATIC_URL = "/static/"
STATIC_ROOT = os.path.join(BASE_DIR, app_name, "staticfiles")
